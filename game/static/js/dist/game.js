...
class Player extends AcGameObject {
    constructor(playground, x, y, radius, color, speed, character, username, photo) {
        ...
        if (this.character === "me") {
            ...
            this.fireball_img.src = "https://app6801.acapp.acwing.com.cn/static/image/playground/skill_image/skill-1.png";

            this.blink_coldtime = 5; // 单位：秒
            this.blink_img = new Image();
            this.blink_img.src = "https://app6801.acapp.acwing.com.cn/static/image/playground/skill_image/skill-2.png";
        }
    }
    ...
    add_listening_events() {
        ...
        this.playground.game_map.$canvas.mousedown(function(e) {
            ...
            } else if (e.which === 1 && outer.is_alive) {
                let tx = (e.clientX - rect.left) / outer.playground.scale;
                let ty = (e.clientY - rect.top) / outer.playground.scale;
    ...
    update_move() { // 更新玩家移动
        ...
        if (this.character === "robot" && this.spent_time > 4 && Math.random() < 1 / 180.0) {
    ...
    render() {
        ...
        if (this.character !== "robot") {
            ...
            this.ctx.stroke();
            this.ctx.clip();
            this.ctx.drawImage(this.img_ai, (this.x - this.radius) * scale, (this.y - this.radius) * scale, this.radius * 2 * scale, this.radius * 2 * scale);
            this.ctx.restore();
        }
        if (this.character === "me" && this.playground.state === "fighting") {
...
class MultiPlayerSocket {
    constructor(playground) {
        ...
        this.ws = new WebSocket("wss://app6801.acapp.acwing.com.cn/wss/multiplayer/");
        this.start();
    }
...
<div class="ac-game-settings">
    <div class="ac-game-settings-login">
        ...
        <div class="ac-game-settings-acwing">
            <img width="30" src="https://app6801.acapp.acwing.com.cn/static/image/settings/acwing_logo.png">
            <br>
            <div>
                AcWing一键登录
            </div>
...
`);
    ...
    acwing_login() {
        $.ajax({
            url: "https://app6801.acapp.acwing.com.cn/settings/acwing/web/apply_code/",
            type: "GET",
    ...
    login_on_remote() {  // 在远程服务器上登录
        ...
        $.ajax({
            url: "https://app6801.acapp.acwing.com.cn/settings/login/",
            type: "GET",
            data: {
                username: username,
                password: password,
    ...
    register_on_remote() { // 在远程服务器上注册
        ...
        $.ajax({
            url: "https://app6801.acapp.acwing.com.cn/settings/register/",
            type: "GET",
            data: {
                username: username,
                password: password,
    ...
    logout_on_remote() { // 在远程服务器上登出
        if (this.platform === "ACAPP") {
            ...
            $.ajax({
                url: "https://app6801.acapp.acwing.com.cn/settings/logout/",
                type: "GET",
                success: function(resp) {
                    if (resp.result === "success") {
                        location.reload();
